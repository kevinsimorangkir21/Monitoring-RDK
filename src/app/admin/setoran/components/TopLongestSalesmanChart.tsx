...
/**
 * TopLongestSalesmanChart — Horizontal bar chart showing the top 10 salesman
 * with the longest average setoran duration.
 *
 * Uses a red color scheme (#EF4444) as a warning indicator for slow performance.
 *
 * Data processing:
 *   - Groups SetoranRecord[] by namaSalesman
 *   - Calculates average duration in minutes per salesman
 *   - Sorts descending by averageDuration and takes the top 10
 *
 * Chart specs (from design.md):
 *   - BarChart layout="horizontal", height=360
 *   - Bar fill: #EF4444, radius: [0, 4, 4, 0], maxBarSize=32
 ...
 *
 * Requirements: 3.1, 3.2, 3.5, 8.1, 8.2
 */
...
export interface TopLongestSalesmanChartProps {
 ...
 * sorts descending and returns the top 10 with 1-based rank.
 *
 * Requirements: 3.1, 3.2
 */
export function buildTop10Longest(records: SetoranRecord[]): SalesmanRankingData[] {
    ...
    // Convert to SalesmanRankingData, sort descending, take top 10
        ...
        >
            ...
            <div className="mb-3 shrink-0">
                <h2 className="text-sm font-bold text-[#111827]">
                    Top 10 Salesman Terlama
                </h2>
                <p className="text-xs text-[#64748B]">
                    Salesman dengan rata-rata durasi terpanjang
                </p>
            </div>
            {/* Empty message */}
...
/**
 * TopLongestSalesmanChart renders a horizontal bar chart of the 10 salesman
 * with the longest average setoran duration.
 *
 ...
 * Requirements: 3.1, 3.2, 3.5, 8.1, 8.2
 */
export const TopLongestSalesmanChart = memo(function TopLongestSalesmanChart({
    data,
    loading = false,
}: TopLongestSalesmanChartProps) {
    // Compute top-10 ranking (Requirement 3.2)
    const chartData = useMemo(() => buildTop10Longest(data), [data]);
    ...
    return (
        <div
            ...
            style={{ height: CHART_HEIGHT }}
            role="img"
            aria-label="Grafik top 10 salesman dengan durasi setoran terpanjang"
        >
            {/* Header */}
            <div className="mb-3 shrink-0">
                <h2 className="text-sm font-bold text-[#111827]">
            ...
            <div className="flex-1 min-h-0">
                <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                        ...
                        {/* Red bar — warning indicator for slow performance (Requirement 3.2) */}
                        <Bar
...
export default TopLongestSalesmanChart;
